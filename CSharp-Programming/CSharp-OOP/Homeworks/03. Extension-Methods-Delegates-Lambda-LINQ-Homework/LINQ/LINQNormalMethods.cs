namespace ExtensionMethodsDelegatesLambdaLINQ.LINQ
{
    ...
    public static class LINQNormalMethods
    {
        public static IEnumerable<T> FirstBeforeLastName<T>(IEnumerable<T> students) where T : Student
        {
        ...
        public static IEnumerable<string> AgeInterval<T>(IEnumerable<T> students, int minAge, int maxAge) where T : Student
        {
            var orderedStudents = students
        ...
        public static IEnumerable<T> SortStudentsByDescending<T>(IEnumerable<T> students) where T : Student
        {
            var orderedStudents = students
        ...
        public static int[] DivisibleBy7And3(int[] numbers)
        {
        ...
        public static IEnumerable<T> StudentsFromSpecificGroup<T>(IEnumerable<T> students, int group) where T : Student
        {
        ...
        public static IEnumerable<T> ExtractStudentsByEmail<T>(IEnumerable<T> students, string domain) where T : Student
        {
        ...
        public static IEnumerable<T> ExtractStudentsByPhoneNumber<T>(IEnumerable<T> students, int phoneGroup, string expectedGroupContain) where T : Student
        {
